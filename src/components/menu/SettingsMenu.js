...
import { avenirNext, Caption, StyledSpan, DIN_FONT, PURPLE_VALUE, dinCSS } from "./../BaseComponents";
...
const SettingsMenu = ({name, onNameChange, onNameTypeChange, includeCommenters, includeTagged, searchPhrase, onSearchPhraseChange, timeRange, onTimeRangeChange, minReacts, onReactsChange}) => (
